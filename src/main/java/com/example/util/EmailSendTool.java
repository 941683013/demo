...
public class EmailSendTool {
    ...
    // 这个是你的邮箱用户名
    private String username = "desyang@qq.com";
    // 你的邮箱密码
    private String password = "ypqcgamrdgyebchj";

    private String mail_head_name = "this is head of this mail";

    private String mail_head_value = "this is head of this mail";

    private String mail_to = "3572424627@qq.com";

    private String mail_from = "desyang@qq.com";
